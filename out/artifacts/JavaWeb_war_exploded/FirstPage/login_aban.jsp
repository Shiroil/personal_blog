...
<body>
    <form method="post" id="form" action="<%=path%>/login">
        <div class="reset">
            ...
            <%--<form action="${pageContext.request.contextPath}/com/servlet/LoginServlet.java" method="post">--%>
            <div class="reset_input">
                <span>用户名:<input type="text" value="${username_used}" name="username"></span>
                <p></p>
            </div>
